...
def play_next_song():
    ...
    for album in albums:
        Genre_path = os.path.join('Music/Album', album, 'Genre.txt')
        album_path = os.path.join('Music/Album', album)
        all_albums.append(os.path.join(album_path, 'Album.mp3'))

    # Play next single by genre
    for single in singles:
        Genre_path = os.path.join('Music/Single', single, 'Genre.txt')
        single_path = os.path.join('Music/Single', single)
        all_albums.append(os.path.join(single_path, 'Single.mp3'))
